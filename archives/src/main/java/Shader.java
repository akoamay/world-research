...
public abstract class Shader
{
	...
	public Shader(String vertexR,String fragmentR,boolean verbose)
	{
		this.VERBOSE=verbose;
		
		final String FRAGMENT = fragmentR;
		final String VERTEX = vertexR;
	...
	public Shader(String vertexR,String fragmentR)
	{
